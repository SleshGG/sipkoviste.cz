...
import { ArrowLeft, AlertCircle, Loader2, X, ImagePlus, Star } from 'lucide-react'
...
const categoryOptions = [
  { id: 'steel-darts', name: 'Ocelové šipky', icon: SteelDartsIcon },
  { id: 'soft-darts', name: 'Softové šipky', icon: SoftDartsIcon },
  { id: 'dartboards', name: 'Terče', icon: DartboardIcon },
  { id: 'accessories', name: 'Příslušenství', icon: AccessoriesIcon },
]
