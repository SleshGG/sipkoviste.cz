...
const features = [
  ...
  },
  {
    icon: MessageCircle,
    title: 'Přímé zprávy',
    description: 'Komunikujte přímo s kupujícími a prodejci',
  },
  {
    icon: Star,
    ...
    <div className="min-h-screen bg-background pb-20 md:pb-0">
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 relative">
          ...
          >
            <Badge variant="secondary" className="mb-4">
              {totalProducts > 0 ? `${totalProducts.toLocaleString('cs-CZ')} inzerátů na tržišti` : 'Největší tržiště šipek v ČR'}
            </Badge>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 text-balance">
              Kupujte a prodávejte{' '}
              <span className="text-primary">prémiové šipky</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 text-pretty">
              Připojte se k tisícům nadšenců do šipek. Najdete profesionální šipky,
              terče a příslušenství od ověřených prodejců.
            </p>
      ...
      <section className="container mx-auto px-3 sm:px-4 py-8 sm:py-12 md:py-16">
        ...
        >
          <div className="flex items-center justify-between mb-4 sm:mb-8">
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-1 sm:mb-2">Procházet kategorie</h2>
              <p className="text-xs sm:text-base text-muted-foreground">Najdete přesně to, co potřebujete</p>
            </div>
      ...
      <section className="container mx-auto px-3 sm:px-4 py-8 sm:py-12 md:py-16">
        ...
        >
          <div className="flex items-center justify-between mb-4 sm:mb-8">
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-1 sm:mb-2">Doporučené inzeráty</h2>
              <p className="text-xs sm:text-base text-muted-foreground">Skvělé nabídky od nejlepších prodejců</p>
            </div>
            <Link href="/marketplace">
              <Button variant="ghost" className="gap-2">
                Zobrazit vše
          ...
          {featuredProducts.length > 0 ? (
            ...
            <Card className="p-8 text-center border-dashed">
              ...
              <p className="text-muted-foreground mb-4">
                Buďte první, kdo přidá inzerát na naše tržiště!
              </p>
              <Link href="/sell">
          ...
          <Card className="relative overflow-hidden border-primary/20 bg-gradient-to-br from-primary/10 via-background to-background p-8 md:p-12">
            <div className="relative z-10 max-w-2xl">
              <h2 className="text-2xl md:text-4xl font-bold mb-4 text-balance">
                Chcete prodat své šipky?
              </h2>
              <p className="text-muted-foreground mb-6 text-pretty">
                Vytvořte inzerát během pár minut. Oslovte tisíce hráčů šipek,
                kteří hledají kvalitní vybavení.
              </p>
              <Link href="/sell">
