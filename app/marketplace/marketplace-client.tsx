...
import type { FiltersState } from '@/components/marketplace-filters'

const MarketplaceFilters = dynamic(
  () => import('@/components/marketplace-filters').then((m) => ({ default: m.MarketplaceFilters })),
  { ssr: true }
)
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            <h2 className="sr-only">Seznam inzerátů</h2>
