...
import { Search, Grid3X3, LayoutGrid, X, Package } from 'lucide-react'
  ...
  const activeFilters = useMemo(() => {
    ...
    if (filters.priceRange[0] > 0 || filters.priceRange[1] < 10000) {
      active.push({
        key: 'price',
        label: 'Cena',
        value: `${filters.priceRange[0].toLocaleString('cs-CZ')} - ${filters.priceRange[1].toLocaleString('cs-CZ')} Kc`,
      })
    }
    ...
    <div className="min-h-screen bg-background pb-20 md:pb-0">
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <h1 className="text-2xl md:text-3xl font-bold mb-2">Trziste</h1>
          <p className="text-muted-foreground">
            Prochazejte {filteredProducts.length} inzeratu
          </p>
        </motion.div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              <SelectTrigger className="w-44">
                <SelectValue placeholder="Radit podle" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="newest">Nejnovejsi</SelectItem>
                <SelectItem value="price-low">Cena: od nejnizsi</SelectItem>
                <SelectItem value="price-high">Cena: od nejvyssi</SelectItem>
                <SelectItem value="rating">Nejlepe hodnocene</SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="flex-1">
            {filteredProducts.length > 0 ? (
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-2">Zadne inzeraty nenalezeny</h3>
                <p className="text-muted-foreground mb-4">
                  {initialProducts.length === 0 
                    ? 'Zatim tu nejsou zadne inzeraty. Budte prvni!'
