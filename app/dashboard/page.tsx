                ...
                <Card className="border-border bg-card lg:col-span-1">
                  <div className="p-4 sm:p-6">
                    <div className="flex items-center gap-2 mb-6">
                      ...
                      <h2 className="font-semibold">Nastavení profilu</h2>
                    </div>
                ...
                <Card className="border-border bg-card lg:col-span-1">
                  <div className="p-4 sm:p-6">
                    <div className="flex items-center gap-2 mb-6">
                      ...
                      <h2 className="font-semibold">Oznámení</h2>
                    </div>
                    <div className="border-t border-border mt-0 pt-6">
                      <h3 className="font-medium mb-4">Předvolby zobrazení</h3>
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between gap-3">
                          <div className="min-w-0">
                            <p className="font-medium text-sm sm:text-base">Upozornění e-mailem</p>
                            <p className="text-xs sm:text-sm text-muted-foreground">
                            Dostávat e-maily při nabídkách a potvrzených nákupech
                            </p>
                          </div>
                          <Switch
                            checked={profile?.email_notifications !== false}
                            onCheckedChange={(checked) => {
                              updateProfileAction({ email_notifications: checked }).then((res) => {
                                if (res.data) setProfile(res.data)
                              })
                            }}
                            className="shrink-0"
                ...
                <Card className="border-border bg-card lg:col-span-1">
                  <div className="p-4 sm:p-6">
                    <div className="flex items-center gap-2 mb-6">
                      ...
                      <h2 className="font-semibold">Zabezpečení</h2>
                    </div>
                    ...
                    <div className="border-t border-border mt-6 pt-6">
                      <h3 className="font-medium mb-4 text-destructive text-sm sm:text-base">Nebezpečná zóna</h3>
                      <div className="space-y-3">
                        <button
                          type="button"
